...
export class OldagramPost extends LitElement {
    ...
    return html`
        <div id="post">
            ...
            <img class="post-image" src="./${this.post}">
            <div id="icons-container">
                <button>
                    <img class="icons" src="./assets/hearth-logo.png">
                </button>
                <button>
                    <img class="icons" id="comment-logo" src="./assets/comment-logo.png">
                </button>
                <button>
                    <img class="icons" id ="send-logo" src="./assets/send-logo.png">
                </button>
            </div>
